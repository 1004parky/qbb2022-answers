...
# First off, I love the comments and usage statement. Certainly better documentation
# than I typically write (although I should). This is a great script. I really
# like the defensive programming, using with, try, and except. The only comment
# that I have is that since you are checking for the edge case of n==0, you could
# save even opening the file by running the check earlier. You could always just
# make your value error require a positive value. Overall, fantastic script! - Mike