...
def parse_vcf(fname):
  ...
  for line in f: 
    if line.startswith("#"):
      ...
      try:
        if line.startswith("##FORMAT"):
          # parse format info line, associate description with ID
      ...
      try:
        ...
        fields[7] = info # dict
        if len(fields) > 8: # genotype fields
    ...
    # If there is space, set 9th element of 1st parsed row as format_description... 
    if len(vcf[0]) > 8:
